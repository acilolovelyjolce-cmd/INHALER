...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,ownerId,name,description,price,compareAtPrice,const DeepCollectionEquality().hash(imageUrls),category,const DeepCollectionEquality().hash(variants),stockStatus,isPublished,sortOrder,createdAt,updatedAt);

@override
String toString() {
  return 'Product(id: $id, ownerId: $ownerId, name: $name, description: $description, price: $price, compareAtPrice: $compareAtPrice, imageUrls: $imageUrls, category: $category, variants: $variants, stockStatus: $stockStatus, isPublished: $isPublished, sortOrder: $sortOrder, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
/// Create a copy of Product
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? ownerId = freezed,Object? name = null,Object? description = null,Object? price = null,Object? compareAtPrice = freezed,Object? imageUrls = null,Object? category = null,Object? variants = freezed,Object? stockStatus = null,Object? isPublished = null,Object? sortOrder = null,Object? createdAt = null,Object? updatedAt = null,}) {
...
as Map<String, dynamic>?,stockStatus: null == stockStatus ? _self.stockStatus : stockStatus // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _Product() when $default != null:
return $default(_that.id,_that.ownerId,_that.name,_that.description,_that.price,_that.compareAtPrice,_that.imageUrls,_that.category,_that.variants,_that.stockStatus,_that.isPublished,_that.sortOrder,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
class _Product implements Product {
  const _Product({required this.id, @JsonKey(name: 'owner_id') this.ownerId, required this.name, required this.description, @NumDoubleConverter() required this.price, @NullableNumDoubleConverter()@JsonKey(name: 'compare_at_price') this.compareAtPrice, @StringListConverter()@JsonKey(name: 'image_urls') required final  List<String> imageUrls, required this.category, final  Map<String, dynamic>? variants, @JsonKey(name: 'stock_status') required this.stockStatus, @JsonKey(name: 'is_published') required this.isPublished, @JsonKey(name: 'sort_order') required this.sortOrder, @JsonKey(name: 'created_at') required this.createdAt, @JsonKey(name: 'updated_at') required this.updatedAt}): _imageUrls = imageUrls,_variants = variants;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,ownerId,name,description,price,compareAtPrice,const DeepCollectionEquality().hash(_imageUrls),category,const DeepCollectionEquality().hash(_variants),stockStatus,isPublished,sortOrder,createdAt,updatedAt);
...
/// Create a copy of Product
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? ownerId = freezed,Object? name = null,Object? description = null,Object? price = null,Object? compareAtPrice = freezed,Object? imageUrls = null,Object? category = null,Object? variants = freezed,Object? stockStatus = null,Object? isPublished = null,Object? sortOrder = null,Object? createdAt = null,Object? updatedAt = null,}) {
