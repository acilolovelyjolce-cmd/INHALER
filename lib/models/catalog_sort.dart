...
enum CatalogSort {
  ...
  String get help => switch (this) {
        manual => 'Customers see inhalers in the order you drag them.',
        priceAsc => 'Customers see the lowest price at the top.',
        priceDesc => 'Customers see the highest price at the top.',
        nameAsc => 'Customers see inhalers in alphabetical order.',
      };
