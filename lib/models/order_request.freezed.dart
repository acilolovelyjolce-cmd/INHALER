...
@JsonKey(name: 'product_id') String get productId;@JsonKey(name: 'product_name') String get productName;@JsonKey(name: 'variant_selection') Map<String, dynamic>? get variantSelection; int get quantity;@NumDoubleConverter()@JsonKey(name: 'price_at_order') double get priceAtOrder;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is OrderItem&&(identical(other.productId, productId) || other.productId == productId)&&(identical(other.productName, productName) || other.productName == productName)&&const DeepCollectionEquality().equals(other.variantSelection, variantSelection)&&(identical(other.quantity, quantity) || other.quantity == quantity)&&(identical(other.priceAtOrder, priceAtOrder) || other.priceAtOrder == priceAtOrder));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,productId,productName,const DeepCollectionEquality().hash(variantSelection),quantity,priceAtOrder);

@override
String toString() {
  return 'OrderItem(productId: $productId, productName: $productName, variantSelection: $variantSelection, quantity: $quantity, priceAtOrder: $priceAtOrder)';
}
...
@useResult
$Res call({
@JsonKey(name: 'product_id') String productId,@JsonKey(name: 'product_name') String productName,@JsonKey(name: 'variant_selection') Map<String, dynamic>? variantSelection, int quantity,@NumDoubleConverter()@JsonKey(name: 'price_at_order') double priceAtOrder
});
...
/// Create a copy of OrderItem
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? productId = null,Object? productName = null,Object? variantSelection = freezed,Object? quantity = null,Object? priceAtOrder = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'product_id')  String productId, @JsonKey(name: 'product_name')  String productName, @JsonKey(name: 'variant_selection')  Map<String, dynamic>? variantSelection,  int quantity, @NumDoubleConverter()@JsonKey(name: 'price_at_order')  double priceAtOrder)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _OrderItem() when $default != null:
return $default(_that.productId,_that.productName,_that.variantSelection,_that.quantity,_that.priceAtOrder);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'product_id')  String productId, @JsonKey(name: 'product_name')  String productName, @JsonKey(name: 'variant_selection')  Map<String, dynamic>? variantSelection,  int quantity, @NumDoubleConverter()@JsonKey(name: 'price_at_order')  double priceAtOrder)  $default,) {final _that = this;
switch (_that) {
case _OrderItem():
return $default(_that.productId,_that.productName,_that.variantSelection,_that.quantity,_that.priceAtOrder);case _:
  throw StateError('Unexpected subclass');
...
class _OrderItem implements OrderItem {
  const _OrderItem({@JsonKey(name: 'product_id') required this.productId, @JsonKey(name: 'product_name') required this.productName, @JsonKey(name: 'variant_selection') final  Map<String, dynamic>? variantSelection, required this.quantity, @NumDoubleConverter()@JsonKey(name: 'price_at_order') required this.priceAtOrder}): _variantSelection = variantSelection;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,productId,productName,const DeepCollectionEquality().hash(_variantSelection),quantity,priceAtOrder);
...
/// Create a copy of OrderItem
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? productId = null,Object? productName = null,Object? variantSelection = freezed,Object? quantity = null,Object? priceAtOrder = null,}) {
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,shopSlug,customerName,customerContact,const DeepCollectionEquality().hash(items),totalAmount,customerNote,status,paymentStatus,internalNotes,createdAt,updatedAt);

@override
String toString() {
  return 'OrderRequest(id: $id, shopSlug: $shopSlug, customerName: $customerName, customerContact: $customerContact, items: $items, totalAmount: $totalAmount, customerNote: $customerNote, status: $status, paymentStatus: $paymentStatus, internalNotes: $internalNotes, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
/// Create a copy of OrderRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? shopSlug = null,Object? customerName = null,Object? customerContact = null,Object? items = null,Object? totalAmount = null,Object? customerNote = freezed,Object? status = null,Object? paymentStatus = null,Object? internalNotes = freezed,Object? createdAt = null,Object? updatedAt = null,}) {
  return _then(_self.copyWith(
...
as PaymentStatus,internalNotes: freezed == internalNotes ? _self.internalNotes : internalNotes // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _OrderRequest() when $default != null:
return $default(_that.id,_that.shopSlug,_that.customerName,_that.customerContact,_that.items,_that.totalAmount,_that.customerNote,_that.status,_that.paymentStatus,_that.internalNotes,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,shopSlug,customerName,customerContact,const DeepCollectionEquality().hash(_items),totalAmount,customerNote,status,paymentStatus,internalNotes,createdAt,updatedAt);
...
/// Create a copy of OrderRequest
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? shopSlug = null,Object? customerName = null,Object? customerContact = null,Object? items = null,Object? totalAmount = null,Object? customerNote = freezed,Object? status = null,Object? paymentStatus = null,Object? internalNotes = freezed,Object? createdAt = null,Object? updatedAt = null,}) {
